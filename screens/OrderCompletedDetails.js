...
export default function OrderCompletedDetails({ route }) {
      ...
      <BottomSheet  index={1} snapPoints={_bottomSheet.snapPoints} handleIndicatorStyle={styles.handleIndicatorStyle}>
        ...
        <TouchableOpacity style={styles.buttonContainer} >
          <View style={styles.button}>
            <Text style={styles.textButton}>{APP_CONSTANT.TEXT.COMPLETED}</Text>
          </View>
        </TouchableOpacity>
      </BottomSheet>
...
const styles = StyleSheet.create({
  ...
  button: {
    ...
    backgroundColor: colors.ORDER_COMPLETED
  },
  textButton: {
    color: colors.white,
    textAlign: "center",
